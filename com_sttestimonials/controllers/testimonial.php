 ...
 * @since  1.6
 */
class SttestimonialsControllerTestimonial extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Testimonial', 'SttestimonialsModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_sttestimonials') || $user->authorise('core.edit.state', 'com_sttestimonials'))
		{
			$model = $this->getModel('Testimonial', 'SttestimonialsModel');
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_sttestimonials&view=testimonials', false));
			}
			else
			{
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_sttestimonials'))
		{
			$model = $this->getModel('Testimonial', 'SttestimonialsModel');
