...
<h1><?php echo $params->get('page_title', 'ST Testimonials');?></h1>
...
<?php 
    ...
    if(count($this->items)) {
        ...
        $average = round($total/count($this->items), 2);
    }
?>

<!-- aggregate review meta data start -->
<span itemscope itemtype="http://schema.org/Service">
  <meta itemprop="name" content="<?php echo $params->get('business_name', $config->get('sitename'));?>" />
  <span itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
    <meta itemprop="ratingValue" content="<?php echo $average;?>" />
    <meta itemprop="reviewCount" content="<?php echo count($this->items);?>" />
  </span>
</span>
...
<div class="st-testimonials-container">
    <?php if(count($this->items)) : ?>
        <?php foreach ($this->items as $i => $item) : ?>
                    ...
                    <?php if($params->get('display_author_pic', 1) == 1) : ?>
                        ...
                        <div class="st-author-img one-forth">
                            ...
                            <div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating">
                                ...
                                <div id="rating-<?php echo $item->id;?>" class="rating"></div>
                            </div>
                        </div>
            ...
            <script type="text/javascript">
                jQuery("#rating-<?php echo $item->id;?>").rateYo({
                    halfStar: true,
                    readOnly: true,
    ...
    <?php else: ?>
        <h4><?php echo JText::_('COM_STTESTIMONIALS_NO_ITEMS');?></h4>
    <?php endif; ?>
